...
- It adds the ability to embed Immich photos in both RedNotebook desktop and Android app.
...
IMMICH_API_KEY=your-api-key" // optional - if you are using Immich
```
...
```
- If you are using Immich, you can use the following format to embed images in your journal entries (for both RedNotebook desktop and Android app):
...
- Ex: add API endpoints for improved search, add authentication, change the service into a Docker image.
